...
let ordersListData2 = Mock.mock({
  'data|20-40': [
    {id: '@id', 
    //0--待处理，1--处理完成
    'status|+1': ['未处理', '处理中', '处理中', '已完成', '已完成'],
    //申请结果
    'result|+1': ['','受理', '不受理', '已通过书面审查', '未通过书面审查'],
    'applyTime|+1': ['2018-01-01', '2018-01-02', '2018-01-03', '2018-01-04', '2018-01-05', '2018-01-06', '2018-01-07', '2018-01-08'],
    accessaries: {regulations:['/图片/1.jpg'],license:['/图片/2.jpg'],credential:['/图片/3.jpg']}, //章程，执照，保密资质
    upload: {file1:'', file2:'', file3:''}, //章程，执照，保密资质
    //以下来自上传Json
